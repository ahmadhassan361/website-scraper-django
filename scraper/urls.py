...
urlpatterns = [
    ...
    path('sync/export-log/<int:export_log_id>/status/', sync_views.export_log_status, name='export_log_status'),
    path('sync/export-log/<int:export_log_id>/download/', sync_views.download_export_by_log, name='download_export_by_log'),
    path('sync/active-jobs/', sync_views.active_jobs_status, name='active_jobs_status'),
